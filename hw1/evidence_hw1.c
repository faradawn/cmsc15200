...
int main(int argc, char *argv[]) {
    ...
    printf("#3: 10 cat, 180g per day, 11 days -> 2 bags \n >> %u bags\n\n",
            bags_of_cat_food(10, 180, 11));
    printf("#4: 0 cat, 180g per day, 11 days -> 0 bags? \n >> %u bags\n\n",
            bags_of_cat_food(0, 180, 11));
